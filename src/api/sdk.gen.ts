...
export const dailyQuotasList = <ThrowOnError extends boolean = false>(options?: Options<DailyQuotasListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<DailyQuotasListResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const remoteEduteamsCreate = <ThrowOnError extends boolean = false>(options: Options<RemoteEduteamsCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RemoteEduteamsCreateResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
