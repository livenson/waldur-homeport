...
export const projectsMarketplaceChecklistsRetrieve = <ThrowOnError extends boolean = false>(options: Options<ProjectsMarketplaceChecklistsRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
...
export const rabbitmqUserStatsRetrieve = <ThrowOnError extends boolean = false>(options?: Options<RabbitmqUserStatsRetrieveData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
...
export const rabbitmqVhostStatsRetrieve = <ThrowOnError extends boolean = false>(options?: Options<RabbitmqVhostStatsRetrieveData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
