...
export const remoteEduteams = <ThrowOnError extends boolean = false>(options: Options<RemoteEduteamsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RemoteEduteamsResponse2, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
