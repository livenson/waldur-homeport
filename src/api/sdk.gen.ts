...
export const customersMarketplaceChecklists = <ThrowOnError extends boolean = false>(options: Options<CustomersMarketplaceChecklistsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
...
export const usersConfirmEmail = <ThrowOnError extends boolean = false>(options: Options<UsersConfirmEmailData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UsersConfirmEmailResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
